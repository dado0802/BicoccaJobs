...
import com.app.bicoccajobs.databinding.ActivityShopProfileBinding;
...
public class ShopProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get current logged in driver data from driver home page screen..
        userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        userName = ShopActivity.fullName;
        userPhone = ShopActivity.phone;
        url = ShopActivity.pic;
        password = ShopActivity.password;
        address = ShopActivity.address;

        //Firebase realtime and storage initialization..
        databaseReference = FirebaseDatabase.getInstance().getReference("ShopsData");
        mStorageRef = FirebaseStorage.getInstance().getReference("ShopsData");
        ...
        binding.tvEmailStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!Utils.checkEmailIsVerified()){
                    Utils.sendVerificationEmail(ShopProfileActivity.this);
                }
            }
        });
    ...
    private void updateAccount() {
        ShopModelCLass model = new ShopModelCLass(userId,userName,url, ShopActivity.email,userPhone,address,password, ShopActivity.userType, ShopActivity.emailVerified);
    ...
    private void updatePic() {
        if(fileUri !=null){
            ...
            final StorageReference fileref = mStorageRef.child(System.currentTimeMillis() + "." + Utils.getExtension(fileUri,ShopProfileActivity.this));
